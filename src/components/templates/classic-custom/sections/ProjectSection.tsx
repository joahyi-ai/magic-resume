...
const ProjectSection: React.FC<ProjectSectionProps> = ({ projects, globalSettings, showTitle = true, title }) => {
    ...
    return (
        <SectionWrapper sectionId="projects" style={{ marginTop: `${globalSettings?.sectionSpacing || 24}px` }}>
            <SectionTitle type={title ? "custom" : "projects"} title={title} globalSettings={globalSettings} showTitle={showTitle} />
